...
public class Table {
    ...
    public Table unique(String name, String columns) {
        this.query.setColumns(this.query.getColumns() + "CONSTRAINT UNI_" + name + " UNIQUE (" + columns + "), ");

        return this;
    }

    public Table unique(String column) {
        this.query.setColumns(this.query.getColumns() + "CONSTRAINT UNI_" + column + " UNIQUE (" + column + "), ");
